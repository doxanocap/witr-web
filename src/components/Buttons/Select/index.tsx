...
const SelectButton: React.FC<Props> = ({ text, onClick }) => {
  return (
    <button
      className="button flex justify-center items-center flex-row w-[128px] h-[44px] mx-[15px] pt-1 px-4 text-h3 bg-white border-2 border-cblue text-cblue rounded-md shadow-md"
      onClick={onClick}
    >
